...
- **Smart Warnings:** Real-time feedback for platform character limits, and overused crutch words.
- **Accessibility & Customization:** Fully responsive layout with a built-in dark and light mode toggle.
- **Extra Utilities:** Built-in text cleaner, one-click copy tool, and Web Speech API text-to-speech reader.
